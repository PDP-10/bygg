...
extern regindex r_define(char* name);
...
extern longword r_read(regindex index, address* addr);
extern void     r_write(regindex index, address* addr, longword value);
...
extern void m_copy(address* fromaddr, address* toaddr, int count);
extern void m_move(address* fromaddr, address* toaddr, int count);
extern void m_exclude(address* fromaddr, int count);
extern void m_include(address* fromaddr, int count);
