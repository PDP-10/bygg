...
extern bool      babsflag;	/* Branch target absolute? */
...
extern int       argdigits;	/* Override number length for this item. */
extern int       argsign;	/* Override sign for this item. */

extern int       radix;		/* Override radix for this item. */
...
extern dispblock* finddisp(byte b, dispblock tbl[], bool (check)(dispblock*));
...
extern void stdstartline(bool nonempty, bool dolabel);
...
extern void genbegin(void);
extern void genend(void);
extern void genorg(address* a);
...
extern void com_rset(regindex index);
...
extern evf_rset* pf_rset;	/* Assign register. */
...
extern void spf_dodef(evf_doobject* handler);
extern void spf_doobj(stcode s, evf_doobject* handler);

extern void spf_begin(evf_begin* handler);
extern void spf_end(evf_end* handler);
extern void spf_org(evf_org* handler);

extern void spf_startline(evf_startline* handler);
extern void spf_restline(evf_restline* handler);
extern void spf_docomment(evf_docomment* handler);
extern void spf_dodescr(evf_dodescr* handler);
