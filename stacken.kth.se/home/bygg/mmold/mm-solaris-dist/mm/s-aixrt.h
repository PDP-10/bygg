...
/*
 * s-aixrt.h - configuration file for AIX 2.2.1 on the IBM RT/PC
 */

#ifdef RCSID
#ifndef lint
static char *s_aixrt_rcsid = "$Header: /w/src1/sun4.bin/cucca/mm/RCS/s-aixrt.h,v 1.5 90/10/04 18:25:45 melissa Exp $";
#endif /* lint */
#endif /* RCSID */

/*
 * The following cpp macros are tested by various AIX include files,
 * and must be defined to turn on various BSD extensions.
 */
 ...
 * long filenames only on remote filesystems (e.g. HP-UX 6.0, AIX 2.2.1), don't
 * define it.
 */
#undef HAVE_FLEXFILENAMES		/* we have long filenames */
 ...
 */
#undef HAVE_JOBS			/* we have job control */
 ...
 */
#undef SETPGRP2			/* setpgrp() takes two args */
/* #define setpgrp setpgrp2 */
