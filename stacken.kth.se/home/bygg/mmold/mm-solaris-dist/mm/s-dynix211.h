...
#ifdef RCSID
#ifndef lint
static char *s_dynix211_rcsid = "$Header: /w/src1/sun4.bin/cucca/mm/RCS/s-dynix211.h,v 2.1 90/10/04 18:25:50 melissa Exp $";
#endif
#endif /* RCSID */

/*
 * s-dynix-211.h - configuration file for Sequent Balance 8000
 *               by Tim Russell, fritz@fergvax.unl.edu
 */
 ...
 */
/* #define HOSTNAME "localhost"		/* local hostname */
...
#undef NEED_UNISTD			/* include <unistd.h> */
#define NEED_SYSFILE
 ...
 */
#undef HAVE_QUOTAS			/* we don't use quota */

/*
 * If you defined HAVE_QUOTAS above, define QUOTACTL if your system has 
 * quotactl(2) system call.  If this is defined, MM also expects to
 ...
 */
#undef HAVE_GETCWD			/* we don't have getcwd() */
 ...
 */
#undef PHOSTNAME 			/* program that prints our hostname */
