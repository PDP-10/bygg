...
#ifdef RCSID
#ifndef lint
static char *s_sun40_rcsid = "$Header: /src/sos5.bin/cucca/mm/mm/RCS/s-sol25.h,v 1.1 1997/10/21 22:02:19 howie Exp $";
#endif
#endif /* RCSID */
...
#undef	HAVE_GETHOSTBYNAME		/* we have gethostbyname() */
 ...
 * SYSV systems.
 */
#define HAVE_UNAME			/* we don't have uname() */
 ...
 */
#undef HAVE_BSD_SETPGRP		/* setpgrp() takes two args */ 
