...
#ifdef RCSID
#ifndef lint
static char *s_sun40_rcsid = "$Header: /w/src1/sun4.bin/cucca/mm/RCS/s-sun40.h,v 2.1 90/10/04 18:26:05 melissa Exp $";
#endif
#endif /* RCSID */

/*
 * s-sun40.h - configuration file for sunos 4.0
 */
 ...
 * there.
 */
#undef MAIL_USE_FLOCK			/* sun /bin/mail uses flock(2) */
...
/*
 * temp kludge for sun fputs() bug
 */
#define sun_stdio_bug 1
/*
