...
#ifdef RCSID
#ifndef lint
static char *s_sysv3b2_rcsid = "$Header: /w/src1/sun4.bin/cucca/mm/RCS/s-sysv3b2.h,v 1.2 90/10/04 18:26:07 melissa Exp $";
#endif
#endif /* RCSID */

/*
 * s-sysv3b2.h - configuration file for 3b2 system V
 */

/* This definition is required.  It appears in the inet.h file
 * which comes with the TWG software.
 */
 ...
 */
/* #define HOSTNAME "aqfc"		/* local hostname */
 ...
 */
/* #define LOCALDOMAIN ".af.mil"	/* local domain */
 ...
 * define it.
 */
/*#define HAVE_FLEXFILENAMES		/* we don't have long filenames */
 ...
 */
/*#define HAVE_QUOTAS			/* we have quota support and use it */

/*
 * If you defined QUOTAS above, define QUOTACTL if your system has quotactl(2)
 * system call.  If this is defined, MM also expects to find quota.h in
 * <sys/quota.h> rather than <ufs/quota.h>.
 */
 ...
 */
/*#define HAVE_INDEX			/* we have index & rindex */
 ...
 */
/*#define HAVE_BSTRING			/* we have bcopy and friends */
 ...
 */
/*#define HAVE_GETWD			/* we have the bsd getwd() */
 ...
 */
/*#define PHOSTNAME "hostname"	/* program that prints our hostname */
...
/*#define HAVE_FLOCK			/* flock locks whole files */
 ...
 * there.
 */
/*#define MAIL_USE_FLOCK		/* ultrix /bin/mail uses flock(2) */
