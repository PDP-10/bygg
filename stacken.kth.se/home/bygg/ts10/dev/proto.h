...
int   rh_ReadIO(UNIT *, int32, int32 *);
int   rh_WriteIO(UNIT *, int32, int32);
int   rh_ReadData18(UNIT *, int18 *);
int   rh_ReadData36(UNIT *, int36 *);
int   rh_WriteData18(UNIT *, int18);
int   rh_WriteData36(UNIT *, int36);
int   rh_Process(UNIT *);
...
int   rm_ReadIO(UNIT *, int32, int32 *);
int   rm_WriteIO(UNIT *, int32, int32);
void  rm_Go(UNIT *);
int   rm_Process(UNIT *);
...
int   rp_ReadIO(UNIT *, int32, int32 *);
int   rp_WriteIO(UNIT *, int32, int32);
void  rp_Go(UNIT *);
int   rp_Process(UNIT *);
...
int   tm_ReadIO(UNIT *, int32, int32 *);
int   tm_WriteIO(UNIT *, int32, int32);
void  tm_Go(UNIT *);
int   tm_Process(UNIT *);
