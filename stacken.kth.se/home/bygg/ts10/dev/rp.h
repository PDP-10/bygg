...
#define RPDC_MASK   0000777 // (R/W)  Desired Cyclinder (for RP04/RP05)
#define RPDC_MBZ    0177000 //        Must be Zeros

// RPCC - Current Cylinder Register
#define RPCC_MASK   0000777 // (R)    Current Cylinder (for RP04/RP05)
#define RPCC_MBZ    0177000 //        Must be Zeros
